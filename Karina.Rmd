...
for (i in nrow(KC_current)) {
  ...
  if (str_detect(KC_current[i, 2], "\\(") == TRUE) {
    ...
    name <- str_split(name, "[\\W]")[[1]][2]
    
    # NEED TO FIX THIS!!!!!
    KC_name <- c(KC_name, name)
  } else {
    # Split name into separate characters
    name <- str_split(KC_current[i, 2], " ")
...
# FIX THE NAME OUTPUT LATER TODAY!!!!!
print(KC_name)


# Names of KCs with parentheses
# KC_current[str_detect(KC_current$Name, "\\(") == TRUE, 2]
```
